...
namespace Capusan_DanielaMaria_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;

        public void PopulateAssignedCategoryData(Capusan_DanielaMaria_Lab8Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Capusan_DanielaMaria_Lab8Context context, string[] selectedCategories, Book bookToUpdate)
        {
